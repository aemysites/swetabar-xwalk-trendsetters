...
## Environments
- Preview: https://main--swetabar-xwalk-trendsetters--aemysites.aem.page/
- Live: https://main--swetabar-xwalk-trendsetters--aemysites.aem.live/
- Block Library: https://main--swetabar-xwalk-trendsetters--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `swetabar-xwalk-trendsetters` directory in your favorite IDE and start coding :)
